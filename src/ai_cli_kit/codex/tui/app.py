...
def build_tui_menu_actions() -> List[TuiMenuAction]:
    return [
        ...
        TuiMenuAction("switch_provider_dry", "2", "模拟切换到当前 provider（Dry-run）", "repair", ("switch-provider", "--dry-run"), is_dry_run=True),
        TuiMenuAction("restore_backup", "3", "从备份恢复", "repair", ("restore-backup", "<backup_dir>")),
        TuiMenuAction("repair_desktop", "4", "修复 Desktop 可见性", "repair", ("repair-desktop",)),
        TuiMenuAction("repair_desktop_dry", "5", "模拟修复 Desktop", "repair", ("repair-desktop", "--dry-run"), is_dry_run=True),
